...
CREATE UNIQUE INDEX profiles_share_code_unique ON public.profiles USING btree (share_code);
...
CREATE POLICY "Authenticated friends can view availability" ON public.availability FOR SELECT TO authenticated USING (((( SELECT auth.uid() AS uid) = user_id) OR (EXISTS ( SELECT 1
   FROM friendships
  WHERE ((friendships.user_id = ( SELECT auth.uid() AS uid)) AND (friendships.friend_user_id = availability.user_id) AND (friendships.status = 'connected'::text))))));
CREATE POLICY "Users can create their own availability" ON public.availability FOR INSERT TO public WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can delete their own availability" ON public.availability FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can update their own availability" ON public.availability FOR UPDATE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can view their own availability" ON public.availability FOR SELECT TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can delete their own calendar connections" ON public.calendar_connections FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can insert their own calendar connections" ON public.calendar_connections FOR INSERT TO authenticated WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can update their own calendar connections" ON public.calendar_connections FOR UPDATE TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can view their own calendar connections" ON public.calendar_connections FOR SELECT TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can delete their own messages" ON public.chat_messages FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = sender_id));
CREATE POLICY "Users can send messages to their conversations" ON public.chat_messages FOR INSERT TO public WITH CHECK (((( SELECT auth.uid() AS uid) = sender_id) AND (conversation_id IN ( SELECT user_conversation_ids(( SELECT auth.uid() AS uid)) AS user_conversation_ids))));
CREATE POLICY "Users can update their own messages" ON public.chat_messages FOR UPDATE TO public USING ((( SELECT auth.uid() AS uid) = sender_id)) WITH CHECK ((( SELECT auth.uid() AS uid) = sender_id));
CREATE POLICY "Users can view messages in their conversations" ON public.chat_messages FOR SELECT TO public USING ((conversation_id IN ( SELECT user_conversation_ids(( SELECT auth.uid() AS uid)) AS user_conversation_ids)));
CREATE POLICY "Conversation creators can add participants" ON public.conversation_participants FOR INSERT TO public WITH CHECK (((EXISTS ( SELECT 1
   FROM conversations
  WHERE ((conversations.id = conversation_participants.conversation_id) AND (conversations.created_by = ( SELECT auth.uid() AS uid))))) OR (( SELECT auth.uid() AS uid) = user_id)));
CREATE POLICY "Users can update their own participation" ON public.conversation_participants FOR UPDATE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can view participants of their conversations" ON public.conversation_participants FOR SELECT TO public USING ((conversation_id IN ( SELECT user_conversation_ids(( SELECT auth.uid() AS uid)) AS user_conversation_ids)));
CREATE POLICY "Users can create conversations" ON public.conversations FOR INSERT TO public WITH CHECK ((( SELECT auth.uid() AS uid) = created_by));
CREATE POLICY "Users can update their conversations" ON public.conversations FOR UPDATE TO public USING ((id IN ( SELECT user_conversation_ids(( SELECT auth.uid() AS uid)) AS user_conversation_ids)));
CREATE POLICY "Users can view their conversations" ON public.conversations FOR SELECT TO public USING (((created_by = ( SELECT auth.uid() AS uid)) OR (id IN ( SELECT user_conversation_ids(( SELECT auth.uid() AS uid)) AS user_conversation_ids))));
CREATE POLICY "Users can insert their own feedback" ON public.feedback FOR INSERT TO public WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can view their own feedback" ON public.feedback FOR SELECT TO public USING ((( SELECT auth.uid() AS uid) = user_id));
...
CREATE POLICY "Users can view incoming friend requests" ON public.friendships FOR SELECT TO public USING ((( SELECT auth.uid() AS uid) = friend_user_id));
...
CREATE POLICY "Users can view their own hang requests" ON public.hang_requests FOR SELECT TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can read their own cache rows" ON public.last_hung_out_cache FOR SELECT TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can add reactions" ON public.message_reactions FOR INSERT TO public WITH CHECK (((( SELECT auth.uid() AS uid) = user_id) AND (EXISTS ( SELECT 1
...
CREATE POLICY "Users can remove their own reactions" ON public.message_reactions FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
...
CREATE POLICY "Users can create their own response" ON public.open_invite_responses FOR INSERT TO authenticated WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can delete their own response" ON public.open_invite_responses FOR DELETE TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can update their own response" ON public.open_invite_responses FOR UPDATE TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can view their own response" ON public.open_invite_responses FOR SELECT TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Recipients can view open invites targeted at them" ON public.open_invites FOR SELECT TO authenticated USING (((status = 'open'::text) AND (expires_at > now()) AND (((audience_type = 'all_friends'::text) AND (EXISTS ( SELECT 1
   FROM friendships
  WHERE ((friendships.user_id = open_invites.user_id) AND (friendships.friend_user_id = ( SELECT auth.uid() AS uid)) AND (friendships.status = 'connected'::text))))) OR ((audience_type = 'pod'::text) AND (EXISTS ( SELECT 1
   FROM (pod_members pm
     JOIN pods p ON ((p.id = pm.pod_id)))
  WHERE ((p.user_id = open_invites.user_id) AND (('pod:'::text || (pm.pod_id)::text) = ('pod:'::text || open_invites.audience_ref)) AND (pm.friend_user_id = ( SELECT auth.uid() AS uid)))))) OR ((audience_type = 'interest'::text) AND (EXISTS ( SELECT 1
   FROM (friendships f
     JOIN profiles pr ON ((pr.user_id = ( SELECT auth.uid() AS uid))))
  WHERE ((f.user_id = open_invites.user_id) AND (f.friend_user_id = ( SELECT auth.uid() AS uid)) AND (f.status = 'connected'::text) AND (open_invites.audience_ref = ANY (pr.interests)))))) OR ((audience_type = 'friends'::text) AND (audience_ref IS NOT NULL) AND ((( SELECT auth.uid() AS uid))::text = ANY (string_to_array(audience_ref, ','::text))) AND (EXISTS ( SELECT 1
   FROM friendships
  WHERE ((friendships.user_id = open_invites.user_id) AND (friendships.friend_user_id = ( SELECT auth.uid() AS uid)) AND (friendships.status = 'connected'::text))))))));
CREATE POLICY "Users can create their own open invites" ON public.open_invites FOR INSERT TO authenticated WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can delete their own open invites" ON public.open_invites FOR DELETE TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can update their own open invites" ON public.open_invites FOR UPDATE TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can view their own open invites" ON public.open_invites FOR SELECT TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Plan members can create change requests" ON public.plan_change_requests FOR INSERT TO public WITH CHECK (((( SELECT auth.uid() AS uid) = proposed_by) AND ((EXISTS ( SELECT 1
   FROM plans
  WHERE ((plans.id = plan_change_requests.plan_id) AND (plans.user_id = ( SELECT auth.uid() AS uid))))) OR (plan_id IN ( SELECT user_participated_plan_ids(( SELECT auth.uid() AS uid)) AS user_participated_plan_ids)))));
CREATE POLICY "Plan owners can delete change requests" ON public.plan_change_requests FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = proposed_by));
CREATE POLICY "Plan owners can update change requests" ON public.plan_change_requests FOR UPDATE TO public USING ((( SELECT auth.uid() AS uid) = proposed_by));
CREATE POLICY "Users can view change requests for their plans" ON public.plan_change_requests FOR SELECT TO public USING (((plan_id IN ( SELECT user_participated_plan_ids(( SELECT auth.uid() AS uid)) AS user_participated_plan_ids)) OR (EXISTS ( SELECT 1
   FROM plans
  WHERE ((plans.id = plan_change_requests.plan_id) AND (plans.user_id = ( SELECT auth.uid() AS uid)))))));
CREATE POLICY "Plan members can create change responses" ON public.plan_change_responses FOR INSERT TO public WITH CHECK ((EXISTS ( SELECT 1
  ...
  WHERE ((cr.id = plan_change_responses.change_request_id) AND ((cr.proposed_by = ( SELECT auth.uid() AS uid)) OR (cr.plan_id IN ( SELECT user_participated_plan_ids(( SELECT auth.uid() AS uid)) AS user_participated_plan_ids)) OR (EXISTS ( SELECT 1
           FROM plans
          WHERE ((plans.id = cr.plan_id) AND (plans.user_id = ( SELECT auth.uid() AS uid))))))))));
CREATE POLICY "Plan members can respond to change requests" ON public.plan_change_responses FOR UPDATE TO public USING ((( SELECT auth.uid() AS uid) = participant_id)) WITH CHECK ((( SELECT auth.uid() AS uid) = participant_id));
CREATE POLICY "Users can view change responses" ON public.plan_change_responses FOR SELECT TO public USING ((EXISTS ( SELECT 1
   FROM plan_change_requests cr
  WHERE ((cr.id = plan_change_responses.change_request_id) AND ((cr.proposed_by = ( SELECT auth.uid() AS uid)) OR (cr.plan_id IN ( SELECT user_participated_plan_ids(( SELECT auth.uid() AS uid)) AS user_participated_plan_ids)))))));
CREATE POLICY "Users can add comments on accessible plans" ON public.plan_comments FOR INSERT TO authenticated WITH CHECK (((( SELECT auth.uid() AS uid) = user_id) AND (EXISTS ( SELECT 1
   FROM plans p
  WHERE ((p.id = plan_comments.plan_id) AND ((p.user_id = ( SELECT auth.uid() AS uid)) OR (plan_comments.plan_id IN ( SELECT user_participated_plan_ids(( SELECT auth.uid() AS uid)) AS user_participated_plan_ids)) OR ((p.feed_visibility <> 'private'::text) AND (EXISTS ( SELECT 1
           FROM friendships f
          WHERE ((f.user_id = ( SELECT auth.uid() AS uid)) AND (f.friend_user_id = p.user_id) AND (f.status = 'connected'::text)))))))))));
CREATE POLICY "Users can delete their own comments" ON public.plan_comments FOR DELETE TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can view comments on accessible plans" ON public.plan_comments FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
  ...
  WHERE ((p.id = plan_comments.plan_id) AND ((p.user_id = ( SELECT auth.uid() AS uid)) OR (plan_comments.plan_id IN ( SELECT user_participated_plan_ids(( SELECT auth.uid() AS uid)) AS user_participated_plan_ids)) OR ((p.feed_visibility <> 'private'::text) AND (EXISTS ( SELECT 1
           FROM friendships f
          WHERE ((f.user_id = ( SELECT auth.uid() AS uid)) AND (f.friend_user_id = p.user_id) AND (f.status = 'connected'::text))))))))));
CREATE POLICY "Inviters can view their own invites" ON public.plan_invites FOR SELECT TO public USING ((( SELECT auth.uid() AS uid) = invited_by));
CREATE POLICY "Plan owners can manage invites" ON public.plan_invites FOR ALL TO public USING ((EXISTS ( SELECT 1
   FROM plans
  WHERE ((plans.id = plan_invites.plan_id) AND (plans.user_id = ( SELECT auth.uid() AS uid)))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM plans
  WHERE ((plans.id = plan_invites.plan_id) AND (plans.user_id = ( SELECT auth.uid() AS uid))))));
CREATE POLICY "Plan participants can create invites" ON public.plan_invites FOR INSERT TO public WITH CHECK (((( SELECT auth.uid() AS uid) = invited_by) AND ((EXISTS ( SELECT 1
   FROM plans
  WHERE ((plans.id = plan_invites.plan_id) AND (plans.user_id = ( SELECT auth.uid() AS uid))))) OR (plan_id IN ( SELECT user_participated_plan_ids(( SELECT auth.uid() AS uid)) AS user_participated_plan_ids)))));
CREATE POLICY "Organizers can update participant requests" ON public.plan_participant_requests FOR UPDATE TO public USING ((EXISTS ( SELECT 1
   FROM plans
  WHERE ((plans.id = plan_participant_requests.plan_id) AND (plans.user_id = ( SELECT auth.uid() AS uid))))));
CREATE POLICY "Organizers can view participant requests" ON public.plan_participant_requests FOR SELECT TO public USING ((EXISTS ( SELECT 1
   FROM plans
  WHERE ((plans.id = plan_participant_requests.plan_id) AND (plans.user_id = ( SELECT auth.uid() AS uid))))));
CREATE POLICY "Plan members can request to add friends" ON public.plan_participant_requests FOR INSERT TO public WITH CHECK (((( SELECT auth.uid() AS uid) = requested_by) AND ((EXISTS ( SELECT 1
   FROM plans
  WHERE ((plans.id = plan_participant_requests.plan_id) AND (plans.user_id = ( SELECT auth.uid() AS uid))))) OR (plan_id IN ( SELECT user_participated_plan_ids(( SELECT auth.uid() AS uid)) AS user_participated_plan_ids)))));
CREATE POLICY "Requesters can delete pending requests" ON public.plan_participant_requests FOR DELETE TO public USING (((( SELECT auth.uid() AS uid) = requested_by) AND (status = 'pending'::text)));
CREATE POLICY "Requesters can view their own requests" ON public.plan_participant_requests FOR SELECT TO public USING ((( SELECT auth.uid() AS uid) = requested_by));
CREATE POLICY "Participants can remove themselves from plans" ON public.plan_participants FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = friend_id));
CREATE POLICY "Participants can update their own status" ON public.plan_participants FOR UPDATE TO public USING ((( SELECT auth.uid() AS uid) = friend_id)) WITH CHECK ((( SELECT auth.uid() AS uid) = friend_id));
CREATE POLICY "Participants can view co-participants" ON public.plan_participants FOR SELECT TO public USING ((plan_id IN ( SELECT user_participated_plan_ids(( SELECT auth.uid() AS uid)) AS user_participated_plan_ids)));
CREATE POLICY "Users can add participants to their plans" ON public.plan_participants FOR INSERT TO public WITH CHECK ((EXISTS ( SELECT 1
   FROM plans
  WHERE ((plans.id = plan_participants.plan_id) AND (plans.user_id = ( SELECT auth.uid() AS uid))))));
...
CREATE POLICY "Users can view participants of their plans" ON public.plan_participants FOR SELECT TO public USING ((EXISTS ( SELECT 1
   FROM plans
  WHERE ((plans.id = plan_participants.plan_id) AND (plans.user_id = ( SELECT auth.uid() AS uid))))));
CREATE POLICY "Users can view plans they participate in" ON public.plan_participants FOR SELECT TO public USING ((( SELECT auth.uid() AS uid) = friend_id));
CREATE POLICY "Plan owners can manage photos" ON public.plan_photos FOR ALL TO public USING ((EXISTS ( SELECT 1
   FROM plans
  WHERE ((plans.id = plan_photos.plan_id) AND (plans.user_id = ( SELECT auth.uid() AS uid))))));
CREATE POLICY "Plan participants can insert photos" ON public.plan_photos FOR INSERT TO public WITH CHECK (((( SELECT auth.uid() AS uid) = uploaded_by) AND ((EXISTS ( SELECT 1
   FROM plans
  WHERE ((plans.id = plan_photos.plan_id) AND (plans.user_id = ( SELECT auth.uid() AS uid))))) OR (plan_id IN ( SELECT user_participated_plan_ids(( SELECT auth.uid() AS uid)) AS user_participated_plan_ids)))));
CREATE POLICY "Plan participants can view photos" ON public.plan_photos FOR SELECT TO public USING ((plan_id IN ( SELECT user_participated_plan_ids(( SELECT auth.uid() AS uid)) AS user_participated_plan_ids)));
CREATE POLICY "Users can delete their own photos" ON public.plan_photos FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = uploaded_by));
CREATE POLICY "Participants can view proposal options" ON public.plan_proposal_options FOR SELECT TO public USING ((plan_id IN ( SELECT user_participated_plan_ids(( SELECT auth.uid() AS uid)) AS user_participated_plan_ids)));
CREATE POLICY "Plan owners can manage proposal options" ON public.plan_proposal_options FOR ALL TO public USING ((EXISTS ( SELECT 1
   FROM plans
  WHERE ((plans.id = plan_proposal_options.plan_id) AND (plans.user_id = ( SELECT auth.uid() AS uid)))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM plans
  WHERE ((plans.id = plan_proposal_options.plan_id) AND (plans.user_id = ( SELECT auth.uid() AS uid))))));
CREATE POLICY "Plan members can view votes" ON public.plan_proposal_votes FOR SELECT TO public USING ((EXISTS ( SELECT 1
  ...
  WHERE ((ppo.id = plan_proposal_votes.option_id) AND ((p.user_id = ( SELECT auth.uid() AS uid)) OR (ppo.plan_id IN ( SELECT user_participated_plan_ids(( SELECT auth.uid() AS uid)) AS user_participated_plan_ids)))))));
CREATE POLICY "Users can delete their votes" ON public.plan_proposal_votes FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can submit their votes" ON public.plan_proposal_votes FOR INSERT TO public WITH CHECK (((( SELECT auth.uid() AS uid) = user_id) AND (EXISTS ( SELECT 1
   FROM (plan_proposal_options ppo
     JOIN plans p ON ((p.id = ppo.plan_id)))
  WHERE ((ppo.id = plan_proposal_votes.option_id) AND ((p.user_id = ( SELECT auth.uid() AS uid)) OR (ppo.plan_id IN ( SELECT user_participated_plan_ids(( SELECT auth.uid() AS uid)) AS user_participated_plan_ids))))))));
CREATE POLICY "Users can update their votes" ON public.plan_proposal_votes FOR UPDATE TO public USING ((( SELECT auth.uid() AS uid) = user_id)) WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can view their own reminders" ON public.plan_reminders_sent FOR SELECT TO public USING ((( SELECT auth.uid() AS uid) = user_id));
...
CREATE POLICY "Participants can update non-time plan fields" ON public.plans FOR UPDATE TO authenticated USING ((id IN ( SELECT user_participated_plan_ids(( SELECT auth.uid() AS uid)) AS user_participated_plan_ids))) WITH CHECK ((id IN ( SELECT user_participated_plan_ids(( SELECT auth.uid() AS uid)) AS user_participated_plan_ids)));
...
CREATE POLICY "Users can create their own plans" ON public.plans FOR INSERT TO public WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can delete their own plans" ON public.plans FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can update their own plans" ON public.plans FOR UPDATE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can view plans they are invited to" ON public.plans FOR SELECT TO public USING ((id IN ( SELECT user_participated_plan_ids(( SELECT auth.uid() AS uid)) AS user_participated_plan_ids)));
CREATE POLICY "Users can view their own plans" ON public.plans FOR SELECT TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can add members to their pods" ON public.pod_members FOR INSERT TO public WITH CHECK ((EXISTS ( SELECT 1
   FROM pods
  WHERE ((pods.id = pod_members.pod_id) AND (pods.user_id = ( SELECT auth.uid() AS uid))))));
...
CREATE POLICY "Users can view members of their pods" ON public.pod_members FOR SELECT TO public USING ((EXISTS ( SELECT 1
   FROM pods
  WHERE ((pods.id = pod_members.pod_id) AND (pods.user_id = ( SELECT auth.uid() AS uid))))));
CREATE POLICY "Users can create their own pods" ON public.pods FOR INSERT TO public WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can delete their own pods" ON public.pods FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can update their own pods" ON public.pods FOR UPDATE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can view their own pods" ON public.pods FOR SELECT TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Authenticated users can view friend profiles" ON public.profiles FOR SELECT TO authenticated USING (((( SELECT auth.uid() AS uid) = user_id) OR (EXISTS ( SELECT 1
   FROM friendships
  WHERE ((friendships.user_id = ( SELECT auth.uid() AS uid)) AND (friendships.friend_user_id = profiles.user_id) AND (friendships.status = 'connected'::text))))));
CREATE POLICY "Users can delete their own profile" ON public.profiles FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
...
CREATE POLICY "Users can manage own push subscriptions" ON public.push_subscriptions FOR ALL TO public USING ((( SELECT auth.uid() AS uid) = user_id)) WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users delete own push_tokens" ON public.push_tokens FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users insert own push_tokens" ON public.push_tokens FOR INSERT TO public WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users select own push_tokens" ON public.push_tokens FOR SELECT TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users update own push_tokens" ON public.push_tokens FOR UPDATE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users delete own reactions" ON public.reactions FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users insert own reactions" ON public.reactions FOR INSERT TO authenticated WITH CHECK (((user_id = ( SELECT auth.uid() AS uid)) AND (((target_type = 'plan'::text) AND (EXISTS ( SELECT 1
   FROM plans p
  WHERE (p.id = reactions.target_id)))) OR ((target_type = 'comment'::text) AND (EXISTS ( SELECT 1
   FROM plan_comments c
  WHERE (c.id = reactions.target_id)))) OR ((target_type = 'photo'::text) AND (EXISTS ( SELECT 1
   FROM plan_photos ph
  WHERE (ph.id = reactions.target_id)))) OR ((target_type = 'vibe'::text) AND (EXISTS ( SELECT 1
   FROM vibe_sends v
  WHERE (v.id = reactions.target_id)))) OR ((target_type = 'message'::text) AND (EXISTS ( SELECT 1
   FROM chat_messages m
  WHERE (m.id = reactions.target_id)))))));
CREATE POLICY "Users read reactions on visible targets" ON public.reactions FOR SELECT TO authenticated USING (((user_id = ( SELECT auth.uid() AS uid)) OR ((target_type = 'plan'::text) AND (EXISTS ( SELECT 1
   FROM plans p
  WHERE (p.id = reactions.target_id)))) OR ((target_type = 'comment'::text) AND (EXISTS ( SELECT 1
   FROM plan_comments c
  WHERE (c.id = reactions.target_id)))) OR ((target_type = 'photo'::text) AND (EXISTS ( SELECT 1
  ...
  WHERE (v.id = reactions.target_id)))) OR ((target_type = 'message'::text) AND (EXISTS ( SELECT 1
   FROM chat_messages m
  WHERE (m.id = reactions.target_id))))));
CREATE POLICY "Users can create their own recurring plans" ON public.recurring_plans FOR INSERT TO public WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can delete their own recurring plans" ON public.recurring_plans FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can update their own recurring plans" ON public.recurring_plans FOR UPDATE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can view their own recurring plans" ON public.recurring_plans FOR SELECT TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can delete their own nudges" ON public.smart_nudges FOR DELETE TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can update their own nudges" ON public.smart_nudges FOR UPDATE TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can view their own nudges" ON public.smart_nudges FOR SELECT TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Participants can add activity suggestions" ON public.trip_activity_suggestions FOR INSERT TO authenticated WITH CHECK (((( SELECT auth.uid() AS uid) = suggested_by) AND is_trip_proposal_participant(proposal_id)));
...
CREATE POLICY "Suggesters can delete own suggestions" ON public.trip_activity_suggestions FOR DELETE TO authenticated USING ((( SELECT auth.uid() AS uid) = suggested_by));
CREATE POLICY "Suggesters can update own suggestions" ON public.trip_activity_suggestions FOR UPDATE TO authenticated USING ((( SELECT auth.uid() AS uid) = suggested_by)) WITH CHECK ((( SELECT auth.uid() AS uid) = suggested_by));
CREATE POLICY "Participants can submit activity votes" ON public.trip_activity_votes FOR INSERT TO authenticated WITH CHECK (((( SELECT auth.uid() AS uid) = user_id) AND (EXISTS ( SELECT 1
...
CREATE POLICY "Participants can view activity votes" ON public.trip_activity_votes FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM trip_activity_suggestions s
  WHERE ((s.id = trip_activity_votes.suggestion_id) AND is_trip_proposal_participant(s.proposal_id)))));
CREATE POLICY "Users can delete own activity votes" ON public.trip_activity_votes FOR DELETE TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can update own activity votes" ON public.trip_activity_votes FOR UPDATE TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id)) WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Connected friends can view trip participants" ON public.trip_participants FOR SELECT TO public USING ((EXISTS ( SELECT 1
   FROM (trips t
     JOIN friendships f ON (((f.user_id = ( SELECT auth.uid() AS uid)) AND (f.friend_user_id = t.user_id) AND (f.status = 'connected'::text))))
  WHERE (t.id = trip_participants.trip_id))));
CREATE POLICY "Participants can view their own participation" ON public.trip_participants FOR SELECT TO public USING ((( SELECT auth.uid() AS uid) = friend_user_id));
CREATE POLICY "Trip owners can manage participants" ON public.trip_participants FOR ALL TO public USING ((EXISTS ( SELECT 1
   FROM trips
  WHERE ((trips.id = trip_participants.trip_id) AND (trips.user_id = ( SELECT auth.uid() AS uid)))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM trips
  WHERE ((trips.id = trip_participants.trip_id) AND (trips.user_id = ( SELECT auth.uid() AS uid))))));
CREATE POLICY "Creator can manage proposal dates" ON public.trip_proposal_dates FOR ALL TO public USING ((EXISTS ( SELECT 1
   FROM trip_proposals tp
  WHERE ((tp.id = trip_proposal_dates.proposal_id) AND (tp.created_by = ( SELECT auth.uid() AS uid)))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM trip_proposals tp
  WHERE ((tp.id = trip_proposal_dates.proposal_id) AND (tp.created_by = ( SELECT auth.uid() AS uid))))));
CREATE POLICY "Participants can view proposal dates" ON public.trip_proposal_dates FOR SELECT TO public USING ((EXISTS ( SELECT 1
  ...
  WHERE ((tpp.proposal_id = trip_proposal_dates.proposal_id) AND (tpp.user_id = ( SELECT auth.uid() AS uid))))));
CREATE POLICY "Users can create invites for proposals they participate in" ON public.trip_proposal_invites FOR INSERT TO authenticated WITH CHECK (((invited_by = ( SELECT auth.uid() AS uid)) AND is_trip_proposal_participant(proposal_id)));
CREATE POLICY "Users can view invites they created" ON public.trip_proposal_invites FOR SELECT TO authenticated USING ((invited_by = ( SELECT auth.uid() AS uid)));
CREATE POLICY "Creator can manage participants" ON public.trip_proposal_participants FOR ALL TO public USING ((EXISTS ( SELECT 1
   FROM trip_proposals tp
  WHERE ((tp.id = trip_proposal_participants.proposal_id) AND (tp.created_by = ( SELECT auth.uid() AS uid)))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM trip_proposals tp
  WHERE ((tp.id = trip_proposal_participants.proposal_id) AND (tp.created_by = ( SELECT auth.uid() AS uid))))));
CREATE POLICY "Participants can update their own record" ON public.trip_proposal_participants FOR UPDATE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
...
CREATE POLICY "Participants can view trip votes" ON public.trip_proposal_votes FOR SELECT TO public USING ((EXISTS ( SELECT 1
  ...
  WHERE ((tpd.id = trip_proposal_votes.date_id) AND (tpp.user_id = ( SELECT auth.uid() AS uid))))));
CREATE POLICY "Users can delete their trip votes" ON public.trip_proposal_votes FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can submit trip votes" ON public.trip_proposal_votes FOR INSERT TO public WITH CHECK (((( SELECT auth.uid() AS uid) = user_id) AND (EXISTS ( SELECT 1
   FROM (trip_proposal_dates tpd
     JOIN trip_proposal_participants tpp ON ((tpp.proposal_id = tpd.proposal_id)))
  WHERE ((tpd.id = trip_proposal_votes.date_id) AND (tpp.user_id = ( SELECT auth.uid() AS uid)))))));
CREATE POLICY "Users can update their trip votes" ON public.trip_proposal_votes FOR UPDATE TO public USING ((( SELECT auth.uid() AS uid) = user_id)) WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));
...
CREATE POLICY "Users can create their own trip proposals" ON public.trip_proposals FOR INSERT TO public WITH CHECK ((( SELECT auth.uid() AS uid) = created_by));
CREATE POLICY "Users can delete their own trip proposals" ON public.trip_proposals FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = created_by));
CREATE POLICY "Users can update their own trip proposals" ON public.trip_proposals FOR UPDATE TO public USING ((( SELECT auth.uid() AS uid) = created_by));
CREATE POLICY "Users can view their own trip proposals" ON public.trip_proposals FOR SELECT TO public USING ((( SELECT auth.uid() AS uid) = created_by));
CREATE POLICY "Connected friends can view trips" ON public.trips FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM friendships
  WHERE ((friendships.user_id = ( SELECT auth.uid() AS uid)) AND (friendships.friend_user_id = trips.user_id) AND (friendships.status = 'connected'::text)))));
CREATE POLICY "Priority friends can view trips" ON public.trips FOR SELECT TO authenticated USING (((( SELECT auth.uid() AS uid) = ANY (priority_friend_ids)) AND (EXISTS ( SELECT 1
   FROM friendships
  WHERE ((friendships.user_id = ( SELECT auth.uid() AS uid)) AND (friendships.friend_user_id = trips.user_id) AND (friendships.status = 'connected'::text))))));
CREATE POLICY "Users can create their own trips" ON public.trips FOR INSERT TO public WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can delete their own trips" ON public.trips FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can update their own trips" ON public.trips FOR UPDATE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Users can view their own trips" ON public.trips FOR SELECT TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Recipients can add comments" ON public.vibe_comments FOR INSERT TO public WITH CHECK (((( SELECT auth.uid() AS uid) = user_id) AND check_vibe_recipient(vibe_send_id)));
...
CREATE POLICY "Senders can add comments on their vibes" ON public.vibe_comments FOR INSERT TO public WITH CHECK (((( SELECT auth.uid() AS uid) = user_id) AND check_vibe_sender(vibe_send_id)));
...
CREATE POLICY "Users can delete their own comments" ON public.vibe_comments FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
CREATE POLICY "Recipients can add vibe reactions" ON public.vibe_reactions FOR INSERT TO public WITH CHECK (((( SELECT auth.uid() AS uid) = user_id) AND check_vibe_recipient(vibe_send_id)));
...
CREATE POLICY "Users can remove their own vibe reactions" ON public.vibe_reactions FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = user_id));
...
CREATE POLICY "Recipients can update their own read status" ON public.vibe_send_recipients FOR UPDATE TO public USING ((( SELECT auth.uid() AS uid) = recipient_id)) WITH CHECK ((( SELECT auth.uid() AS uid) = recipient_id));
CREATE POLICY "Recipients can view their own entries" ON public.vibe_send_recipients FOR SELECT TO public USING ((( SELECT auth.uid() AS uid) = recipient_id));
...
CREATE POLICY "Users can create their own vibes" ON public.vibe_sends FOR INSERT TO public WITH CHECK ((( SELECT auth.uid() AS uid) = sender_id));
CREATE POLICY "Users can delete their own vibes" ON public.vibe_sends FOR DELETE TO public USING ((( SELECT auth.uid() AS uid) = sender_id));
CREATE POLICY "Users can view vibes sent to them" ON public.vibe_sends FOR SELECT TO public USING (check_vibe_recipient(id));
CREATE POLICY "Users can view vibes they sent" ON public.vibe_sends FOR SELECT TO public USING ((( SELECT auth.uid() AS uid) = sender_id));
CREATE POLICY "Users can create their own intentions" ON public.weekly_intentions FOR INSERT TO public WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));
